...
function renderReporteActual() {
  // 1. Guardar TODOS los valores de filtro ANTES de reconstruir selects
  ...
  // 2. Reconstruir selects dinámicos
  llenarSelectPlanes('rep-plan-filtro', true);
  updateAuditorSelect('rep-filtro-auditor');

  // 3. Restaurar valores guardados DESPUÉS de reconstruir
  ...
  // 4. Ahora sí filtrar con los valores correctos
